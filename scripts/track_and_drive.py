...
def main():
    inner_track, middle_track, outer_track = generate_track(30, size_x=5, size_y=5, refinements=2, n_points=40, track_width=6)
    ...
    #node = TrackPlanner(middle_track[left_most_point:])
    #node = TrackPlanner(np.array([[-10.0, -10.0]]))
